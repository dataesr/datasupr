...
router.route("/european-projects/overview/graph1").get(async (req, res) => {
  ...
  const data = await db
    .collection("fr-esr-all-projects-entities")
...
router
  .route("/european-projects/overview/pillars-funding-proportion")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code"], res);
...
router
  .route("/european-projects/overview/programs-funding")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code", "pillars"], res);
...
router
  .route("/european-projects/overview/programs-funding-proportion")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code", "pillars"], res);
...
router
  .route("/european-projects/overview/topics-funding")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code"], res);
...
router
  .route("/european-projects/overview/topics-funding-proportion")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code"], res);
...
router
  .route("/european-projects/overview/destination-funding")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code"], res);
...
router
  .route("/european-projects/overview/destination-funding-proportion")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code"], res);
...
router
  .route("/european-projects/overview/pillars-funding-evo-3-years")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code"], res);
...
router
  .route("/european-projects/overview/programs-funding-evo-3-years")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code"], res);
...
router
  .route("/european-projects/overview/topics-funding-evo-3-years")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code"], res);
...
router
  .route("/european-projects/overview/destinations-funding-evo-3-years")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code"], res);
...
router
  .route("/european-projects/overview/projects-types-2")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code"], res);
...
router
  .route("/european-projects/overview/projects-types-3")
  .get(async (req, res) => {
    const filters = checkQuery(req.query, ["country_code"], res);
