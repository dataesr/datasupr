  ...
  try {
    ...
    const items = await fetchAllRecords({
      select: [
        ...
        "taux_de_remuneration_des_permanents_etat",
        "charges_de_personnel_produits_encaissables",
        "charges_de_personnel_produits_encaissables_etat",
        "ressources_propres_produits_encaissables",
        "ressources_propres_produits_encaissables_etat",
        "charges_decaissables_produits_encaissables",
        "charges_decaissables_produits_encaissables_etat",
