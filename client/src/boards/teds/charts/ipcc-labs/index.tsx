...
import ChartWrapper from "../../chart-wrapper/index.tsx";
import bool from "./query.tsx";
...
export default function IpccInstitutions() {
  ...
  const title = getLabel("ipcc_labs", "title", currentLang);

  const options = getOptions(
    series,
    categories,
    title,
    getLabel("ipcc_labs", "format1", currentLang),
    getLabel("ipcc_labs", "format2", currentLang),
    getLabel("ipcc_labs", "title_x_axis", currentLang),
    getLabel("ipcc_labs", "title_y_axis", currentLang)
  );
