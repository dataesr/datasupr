...
const iso3ToIso2 = {
  ...
  SVN: 'SI', SLB: 'SB', SOM: 'SO', ZAF: 'ZA', SGS: 'GS', ESP: 'ES', LKA: 'LK', SDN: 'SD',
  SUR: 'SR', SJM: 'SJ', SWZ: 'SZ', SWE: 'SE', CHE: 'CH', SYR: 'SY', TWN: 'TW', TJK: 'TJ',
  TZA: 'TZ', THA: 'TH', TLS: 'TL', TGO: 'TG', TKL: 'TK', TON: 'TO', TTO: 'TT', TUN: 'TN',
  TUR: 'TR', TKM: 'TM', TCA: 'TC', TUV: 'TV', UGA: 'UG', UKR: 'UA', ARE: 'AE', GBR: 'GB',
  USA: 'US', UMI: 'UM', URY: 'UY', UZB: 'UZ', VUT: 'VU', VEN: 'VE', VNM: 'VN', VIR: 'VI',
...
export function getFlagEmoji(countryCode) {
  ...
  // Convertir le code ISO3 en ISO2 si nécessaire
  const iso2Code = countryCode.length === 3 
    ? iso3ToIso2[countryCode.toUpperCase()] 
    : countryCode;
