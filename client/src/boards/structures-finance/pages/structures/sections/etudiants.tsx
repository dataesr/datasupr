            ...
            <div style={{ flex: "1 1 100%", minWidth: "200px" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
                ...
                {data?.has_effectif_llsh &&
                  data?.effectif_sans_cpge_llsh > 0 && (
                    <SmallMetricCard
                ...
                {data?.has_effectif_staps &&
                  data?.effectif_sans_cpge_staps > 0 && (
                    <SmallMetricCard
                      ...
                      sparklineData={effectifStapsEvolution?.map(
                        (d) => d.value
                      )}
                    />
                  )}
                {data?.has_effectif_theo &&
                  data?.effectif_sans_cpge_theo > 0 && (
                    <SmallMetricCard
                      label="Théologie"
                ...
                {data?.has_effectif_veto &&
                  data?.effectif_sans_cpge_veto > 0 && (
                    <SmallMetricCard
                      label="Vétérinaire"
                ...
                {data?.has_effectif_interd &&
                  data?.effectif_sans_cpge_interd > 0 && (
                    <SmallMetricCard
                      ...
                      sparklineData={effectifInterdEvolution?.map(
                        (d) => d.value
                      )}
                    />
                  )}
