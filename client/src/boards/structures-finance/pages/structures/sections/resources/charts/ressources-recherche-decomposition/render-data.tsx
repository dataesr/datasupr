import { RECHERCHE_CATEGORIES } from "./options";
      ...
      <div className="fr-table__wrapper">
        <div className="fr-table__container">
          <div className="fr-table__content">
            <table
              id="ressources-recherche-decomposition-table"
              style={{ width: "100%" }}
            >
              <thead>
                <tr>
              ...
              <tbody>
                ...
                >
                  ...
                  {sortedData.map((d) => {
                    let total = 0;
                    RECHERCHE_CATEGORIES.forEach((cat) => {
                      total += (d as any)[cat.valueKey] || 0;
                    });
                    return (
