...
export default function InstrumentsOverTimeForEurope({ name }: { name: string | undefined }) {
  ...
  const config = {
    ...
    id: "projectsOverTimeForEurope",
  };

  // If view by number of projects
  let axis = getI18nLabel(i18n, 'number_of_projects_funded');
  let series = seriesProject.reverse();
  let title = `Evolution temporelle des instruments de l'Europe dont a bénéficié l'établissement (${name})`;
  ...
  switch (selectedControl) {
    ...
    case 'amount_global':
      ...
      title = `Evolution temporelle du montant financé par instrument de l'Europe dont a bénéficié l'établissement (${name})`;
    ...
    case 'amount_by_structure':
      ...
      title = `Evolution temporelle du montant perçu par instrument de l'Europe dont a bénéficié l'établissement (${name})`;
      tooltip = function (this: any) {
