...
export const useFinanceYears = (enabled = true) => {
  return useQuery({
    ...
    queryFn: async () => {
      const url = `${VITE_APP_SERVER_URL}/finance-universite/filters/years`;
...
export const useFinanceNationalOverview = (annee?: string, enabled = true) => {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const url = `${VITE_APP_SERVER_URL}/finance-universite/national/overview${
...
export const useFinanceComparisonFilters = (annee?: string, enabled = true) => {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const url = `${VITE_APP_SERVER_URL}/finance-universite/comparisons/filters${
...
export const useFinanceComparison = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const url = `${VITE_APP_SERVER_URL}/finance-universite/comparisons/compare${
        sp.toString() ? `?${sp.toString()}` : ""
      }`;
      const response = await fetch(url);
      if (!response.ok) {
...
export const useFinanceAdvancedComparison = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const url = `${VITE_APP_SERVER_URL}/finance-universite/comparisons/advanced${
        sp.toString() ? `?${sp.toString()}` : ""
      }`;
      const response = await fetch(url);
      if (!response.ok) {
...
export const useFinanceComparisons = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const url = `${VITE_APP_SERVER_URL}/finance-universite/comparaisons${
        sp.toString() ? `?${sp.toString()}` : ""
      }`;
      const response = await fetch(url);
      if (!response.ok) {
...
export const useFinanceEtablissements = (annee?: string, enabled = true) => {
  return useQuery({
    ...
    queryFn: async () => {
      const sp = new URLSearchParams();
      if (annee) sp.append("annee", annee);
      const url = `${VITE_APP_SERVER_URL}/finance-universite/etablissements${
        sp.toString() ? `?${sp.toString()}` : ""
      }`;
      const response = await fetch(url);
      if (!response.ok) {
...
export const useFinanceEtablissementDetail = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const sp = new URLSearchParams();
      if (annee) sp.append("annee", annee);
      const url = `${VITE_APP_SERVER_URL}/finance-universite/etablissements/${id}/detail${
        sp.toString() ? `?${sp.toString()}` : ""
      }`;
      const response = await fetch(url);
      if (!response.ok) {
...
export const useFinanceEtablissementEvolution = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!id) throw new Error("missing id");
      const url = `${VITE_APP_SERVER_URL}/finance-universite/etablissements/${id}/evolution`;
      const response = await fetch(url);
      if (!response.ok) {
        throw new Error(
...
export const useFinanceEtablissementOverview = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const sp = new URLSearchParams();
      if (annee) sp.append("annee", annee);
      const url = `${VITE_APP_SERVER_URL}/finance-universite/etablissements/${id}/overview${
        sp.toString() ? `?${sp.toString()}` : ""
      }`;
      const response = await fetch(url);
      if (!response.ok) {
...
export const useFinanceEvolutionNational = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (typologie) sp.append("typologie", typologie);
      if (region) sp.append("region", region);
      const url = `${VITE_APP_SERVER_URL}/finance-universite/evolutions/national${
        sp.toString() ? `?${sp.toString()}` : ""
      }`;
      const response = await fetch(url);
      if (!response.ok) {
...
export const useFinanceComparisonData = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const sp = new URLSearchParams();
      if (annee) sp.append("annee", annee);
      const url = `${VITE_APP_SERVER_URL}/finance-universite/comparisons/data${
        sp.toString() ? `?${sp.toString()}` : ""
      }`;
      const response = await fetch(url);
      if (!response.ok) {
