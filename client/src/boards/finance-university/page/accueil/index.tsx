...
export default function AccueilView() {
  ...
  const handleEtablissementSelect = (etablissementId: string) => {
    navigate(
      `/finance-universite/etablissements?year=${latestYear}&type=tous&region=toutes&structureId=${etablissementId}`
    );
    setSearchTerm("");
  };
  ...
  const cards: QuickAccessCard[] = [
    {
      ...
      path: "/finance-universite/vue-nationale",
    ...
    },
    {
      ...
      path: "/finance-universite/etablissements",
    ...
    },
    {
      ...
      path: "/finance-universite/comparaisons",
