...
export const useGeneralIndicators = ({
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const endpoints = {
        fields: "/faculty-members/fields/general-indicators",
        geo: "/faculty-members/geo/general-indicators",
        structures: "/faculty-members/structures/general-indicators",
      };
      ...
      if (!response.ok) {
        throw new Error(
          "Erreur lors de la récupération des indicateurs généraux"
        );
      }
