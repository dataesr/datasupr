...
export default function TopInternationalPartnersByStructure() {
  ...
  const options = {
    ...
    title: { text: `Partenaires internationaux, insitutionnels et actifs sur la période ${selectedYearStart}-${selectedYearEnd}` }
  };
