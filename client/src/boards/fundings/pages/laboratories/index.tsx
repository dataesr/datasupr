...
import ParticipationsOverTimeBudgetByLaboratory from "./charts/participations-over-time-budget-by-laboratory";
import ParticipationsOverTimeByLaboratory from "./charts/participations-over-time-by-laboratory";
...
export default function Structures() {
  return (
    <Container>
      ...
      <Row gutters>
        <Col>
          <ParticipationsOverTimeBudgetByLaboratory />
        </Col>
      </Row>
      <Row gutters>
        <Col>
          <ParticipationsOverTimeByLaboratory />
        </Col>
      </Row>
    </Container>
  );
