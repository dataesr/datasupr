...
export default function ParticipationsOverTimeByLaboratory() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['fundings-participations-over-time-by-laboratory', selectedLaboratoryId],
    queryFn: () =>
  ...
  const config = {
    id: "participationsOverTimeByLaboratory",
    integrationURL: "/integration?chart_id=participationsOverTimeByLaboratory",
    title: `Nombre de projets pour ${getLabelFromName(selectedLaboratoryId)} par financeur sur la période ${years[0]}-${years[years.length - 1]}, par année de début du projet`,
  };
