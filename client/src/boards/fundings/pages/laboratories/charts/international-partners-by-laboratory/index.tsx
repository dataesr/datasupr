...
export default function InternationalPartnersByLaboratory() {
  ...
  const { data: dataPartners, isLoading: isLoadingPartners } = useQuery({
    queryKey: ['fundings-international-partners', selectedLaboratoryId, selectedYearEnd, selectedYearStart],
    queryFn: () =>
  ...
  const config = {
    id: "internationalPartnersByLaboratory",
    integrationURL: "/integration?chart_id=internationalPartnersByLaboratory",
  };
  ...
  return (
    <div className={`chart-container chart-container--${color}`} id="international-partners-by-laboratory">
      <Title as="h3" look="h6">
