...
export default function FundedStructuresEuropeBudget() {
  ...
  const config = {
    ...
    title: `Top 25 des structures européennes (hors France) par montant des financements des projets auxquels elles participent sur la période ${selectedYearStart}-${selectedYearEnd}`,
  };
