    ...
    <Container as="section" fluid>
      ...
      <Row className="fr-mt-5w">
        <Col md={6}>
          ...
          <Link href={`/atlas/effectifs-par-secteurs?${params}`}>Voir le détail des effectifs par secteur</Link>
        </Col>
        <Col md={6}>
          <SectorsCard
      ...
      <Row className="fr-mt-5w">
        <Col md={6}>
          ...
          <Text>
            ...
            <br />
            <br />
            <strong>{effectifM.toLocaleString()}</strong> étudiants sont de genre masculin et <strong>{effectifF.toLocaleString()}</strong> de genre féminin, soit une répartition de <strong>{pctM}%</strong> dans le genre masculin et <strong>{pctF}%</strong> dans le genre féminin pour l'année universitaire <Badge color="yellow-tournesol">{currentYear}</Badge>.
          </Text>
